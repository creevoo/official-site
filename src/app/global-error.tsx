      ...
      <body suppressHydrationWarning>
        <main className="min-h-screen py-20 tablet:py-36 tablet:pb-56">
          ...
          <p className="mt-7 leading-relaxed! laptop:w-10/12 text-center text-foreground">
            Opps, something happen, don't panic. This can be happen when the url
            is invalid or deleted, this mean your pages is not found. Start
            explore another one, we help you find better way to navigate through
            header and footer. “I’am your designer & developer”.
          </p>
